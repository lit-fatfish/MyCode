...
# 1、数据集转换
python data_convert_tfrecords.py --dataset_dir=/mnt/tf_data/huanjian/board_guobiao

# 2、inception-V3 模型为基础进行迁移训练【用的会比较多】
DATASET_DIR=/mnt/tf_data/huanjian/board_guobiao
TRAIN_DIR=/mnt/tf_data/train_logs/huanjian/board_guobiao
...
# 4、评估模型性能
CHECKPOINT_FILE=/mnt/tf_data/train_logs/huanjian/board_guobiao
...
python export_inference_graph.py \
  --alsologtostderr \
  --model_name=inception_v3 \
  --output_file=/mnt/tf_data/tf_models/huanjian/board_guobiao/inception_v3_inf_graph.pb \
  --dataset_name flowers
...
python /usr/local/lib/python3.6/dist-packages/tensorflow_core/python/tools/freeze_graph.py \
  --input_graph /mnt/tf_data/tf_models/huanjian/board_guobiao/inception_v3_inf_graph.pb \
  --input_checkpoint /mnt/tf_data/train_logs/huanjian/board_guobiao/model.ckpt-140330 \
  --input_binary true \
  --output_node_names InceptionV3/Predictions/Reshape_1 \
  --output_graph /mnt/tf_data/tf_models/huanjian/board_guobiao/board_guobiao_inception_v3.pb
...
python classify_image.py \
  --model_path /mnt/tf_data/tf_models/huanjian/board_guobiao/board_guobiao_inception_v3.pb \
  --label_path /mnt/tf_data/huanjian/board_guobiao/labels.txt \
  --image_path /mnt/tf_data/tf_test_data/board_rb/board_guobiao
